...
local function create_commands()
  cmd[[command! KittyREPLRunAgain lua require('kitty-runner').repl_run_again()]]
  cmd[[command! -range KittyREPLSend lua require('kitty-runner').repl_run(vim.region(0, vim.fn.getpos("'<"), vim.fn.getpos("'>"), "l", false)[0])]]
  cmd[[command! KittyREPLRun lua require('kitty-runner').repl_prompt_and_run()]]
  cmd[[command! KittyREPLClear lua require('kitty-runner').repl_cleanup()]]
  cmd[[command! KittyREPLKill lua require('kitty-runner').repl_killer()]]
  -- move this one elsewere...
  cmd[[command! StartIPythonConsole lua require('kitty-runner').repl_send_and_run("MPLBACKEND='module://kitty' ipython")]]
  cmd[[command! StartClingConsole lua require('kitty-runner').repl_send_and_run("cling")]]
end
